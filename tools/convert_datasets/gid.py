...
def main():
    ...
    for image in train_list:
        ...
        src_image_path = osp.join(dataset_path, 'image_RGB', image)
        src_image_nirrgb_path = osp.join(dataset_path, 'image_NirRGB', image)
        ...
        src_mask_id = src_mask.dot(np.array([[65536], [256], [1]])).squeeze(-1)
        src_label = 255 * np.ones_like(src_mask_id)
